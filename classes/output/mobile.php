...
namespace mod_pandavideo\output;
...
/**
 * Output Mobile for mod_pandavideo.
 *
...
class mobile {
    ...
    public static function mobile_course_view($args) {
        ...
        $url = new moodle_url("/mod/pandavideo/view-mobile.php", [
            "id" => $args["cmid"],
        ...
        return [
            "templates" => [
                [
                    "id" => "main",
                    "html" => $OUTPUT->render_from_template("mod_pandavideo/mobile", $data),
                ],
            ],
            "javascript" => "",
            "otherdata" => "",
