 ...
 * Class pandavideo_filepicker
 */
class pandavideo_filepicker extends HTML_QuickForm_input implements templatable {
    use templatable_form_element {
    ...
    public function toHtml() { // phpcs:disable
        ...
        $module = [
            "name" => "pandavideo_filepicker",
            "fullpath" => "/mod/pandavideo/classes/form/pandavideo_filepicker.js",
            "requires" => [
                "core_filepicker",
                "node",
                "node-event-simulate",
        ...
        $PAGE->requires->js_init_call("M.pandavideo_filepicker.init", [$fp->options], true, $module);
